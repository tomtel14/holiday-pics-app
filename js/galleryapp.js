...
randomBtn.addEventListener('click', function (e) {
    ...
    countryItems.randomImages = arrayShuffle(galleryImages); // create a property called randomImages
